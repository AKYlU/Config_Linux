...

{
  ...
  networking.bridges.br0.interfaces = [ "enp3s0" ];  # aqui sua interface real
  ...
  environment.systemPackages = with pkgs; [              # Pacotes instalados globalmente
    ...
    swww                # wallpepar
    spice-vdagent       # habilita copiar/colar
    ...
    # android-tools                  # adb
    xdg-utils                        # steam para deligar
    evemu                            # para deligar pela steam
